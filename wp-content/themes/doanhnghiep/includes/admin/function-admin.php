...
function ch_essentials_admin() {
	...
	/* Base Menu */
	add_menu_page('Theme Option','Thay đổi thông tin','manage_options','template_admin_zang','zang_theme_create_page',get_template_directory_uri() . '/images/tenten.png',110);
}
